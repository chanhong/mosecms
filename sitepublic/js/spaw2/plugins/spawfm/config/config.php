...
// default icons
SpawConfig::setStaticConfigItem(
        'PG_SPAWFM_FILETYPES_ICON_DEFAULT', array(
...
// icons for folders
SpawConfig::setStaticConfigItem(
        'PG_SPAWFM_FILETYPES_ICON_FOLDER', array(
    'icon' => 'ico_folder.gif',
...
SpawConfig::setStaticConfigItem(
        'PG_SPAWFM_FILETYPES_ICONS', array(
    array(
...
SpawConfig::setStaticConfigItem(
        'spawfm_path_separator', '|', SPAW_CFG_TRANSFER_JS
);
?>