...
var TinyMCE_FlashPlugin = {getInfo: function() {
        return{longname: 'Flash', author: 'Moxiecode Systems AB', authorurl: 'http://tinymce.moxiecode.com', infourl: 'http://tinymce.moxiecode.com/tinymce/docs/plugin_flash.html', version: tinyMCE.majorVersion + "." + tinyMCE.minorVersion}
        ...
        switch (command) {
            case"mceFlash":
                ...
                if (focusElm != null && focusElm.nodeName.toLowerCase() == "img") {
                    ...
                    if (name.indexOf('mceItemFlash') == -1)
                        return true;
